...
// Forwards the visualizer lead payload to the n8n Lead Intake (Visualizer) workflow.
// Kept server-side (no NEXT_PUBLIC_ prefix) so the n8n webhook URL never ships to the browser.
