...
export default function TermsPage() {
  return (
    <LegalShell title="Terms of Service">
      ...
      <LH id="sms-program">3. SMS Program</LH>
      <p>Metroplex Metal Roofs operates an SMS messaging program to communicate with homeowners regarding roofing inquiries, estimates, appointment confirmations, and project updates. By opting in through our website forms, you consent to receive these messages at the phone number provided.</p>
      <p style={{marginTop:12}}>Message frequency varies. Message and data rates may apply. Reply <strong>STOP</strong> to cancel at any time. Reply <strong>HELP</strong> for help. For additional support contact {EMAIL} or {PHONE}.</p>
      <p style={{marginTop:12}}>Carrier Disclaimer: Carriers are not liable for delayed or undelivered messages.</p>
      <p style={{marginTop:12}}>Age Restriction: Our SMS program is intended for individuals 18 years of age or older. By opting in, you confirm you are at least 18 years old.</p>
      <p style={{marginTop:12}}>Our Privacy Policy, available at <a href="/privacy" style={{color:"#B8935A",textDecoration:"underline"}}>metroplexmetalroofs.com/privacy</a>, describes how we collect, use, and protect your information, including SMS opt-in data.</p>

      <LH>4. Roof Visualizer Tool</LH>
