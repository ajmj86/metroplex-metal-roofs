...
/* Group display order for the Stone swatch modal. */
export const STONE_PROFILE_ORDER = ["Barrel", "Shake", "Shingle"];

/* One representative color per stone product line, used for the 4 row chips. */
export const STONE_ROW_PREVIEW = [
  { product: "Barrel Vault Tile",    name: "Timberwood" },
  { product: "Pacific Tile",         name: "Timberwood" },
  { product: "Pine-Crest Shake",     name: "Timberwood" },
  { product: "Granite Ridge Shingle", name: "Timberwood" },
];
