...
export function AboutCTA() {
  return (
    <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', marginTop: 56 }}>
      ...
      <a href="/estimate"
        style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '15px 32px', background: 'transparent', color: C.accent, fontSize: 11, letterSpacing: 2, textTransform: 'uppercase', fontWeight: 600, borderRadius: 2, border: `1px solid ${C.accent}`, transition: 'all 0.2s', whiteSpace: 'nowrap', textDecoration: 'none' }}
        onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.background = `${C.accent}18` }}
