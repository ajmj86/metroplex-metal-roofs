...
const stats = [
  ...
  {val:101, suffix:"%",     label:"ROI vs. Asphalt", tooltip:[
    ...
    {label:"Annual utilities", value:"$4,017"},
...
const HomePage = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <div>
      ...
      {/* ── HOA APPROVAL KIT ── */}
      <section className="section-pad" style={{borderTop:`1px solid ${C.border}`}}>
        <div className="inner" style={{maxWidth:820}}>
          <Reveal>
            <div style={{background:C.card,border:`1px solid ${C.accentDark}`,borderRadius:8,padding:"clamp(28px,4vw,44px)",display:"flex",gap:24,alignItems:"flex-start",position:"relative",overflow:"hidden",flexWrap:"wrap"}}>
              <div style={{position:"absolute",top:0,left:0,right:0,height:3,background:`linear-gradient(90deg,${C.accentDark},${C.accent},${C.accentDark})`}}/>
              <div style={{width:52,height:52,borderRadius:"50%",background:`${C.accentDark}33`,border:`1px solid ${C.accentDark}`,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={C.accent} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div style={{maxWidth:640,margin:"0 auto",textAlign:"center",position:"relative"}}>
          <Reveal>
            ...
            <div style={{display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap"}}>
              ...
              >{PHONE}</a>
              <a href="sms:+18173823338?body=ROOF" className="cta-btn" style={{padding:"16px 28px",border:`1px solid ${C.borderLight}`,color:C.mutedLight,fontSize:12,letterSpacing:2,textTransform:"uppercase",fontWeight:500,borderRadius:2,transition:"all 0.2s"}}
                onMouseEnter={e=>{e.currentTarget.style.borderColor=C.accent;e.currentTarget.style.color=C.accent;}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor=C.borderLight;e.currentTarget.style.color=C.mutedLight;}}
