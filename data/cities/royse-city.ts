...
export const ROYSE_CITY_DATA: CityData = {
  ...
  faqs: [
    { q: 'How much does a metal roof cost in Royse City, TX?', a: 'Metal roofing in Royse City typically ranges from $13,000 to $48,000 depending on roof size, pitch, and material. We provide satellite-based estimates from actual roof measurements before any commitment.' },
