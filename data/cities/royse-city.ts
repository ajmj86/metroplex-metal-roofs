...
export const ROYSE_CITY_DATA: CityData = {
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Royse City, TX?', a: 'Metal roofing in Royse City typically ranges from $13,000 to $48,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment.' },
