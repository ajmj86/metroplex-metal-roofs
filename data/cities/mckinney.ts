...
export const MCKINNEY_DATA: CityData = {
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in McKinney, TX?', a: 'Metal roofing in McKinney typically ranges from $18,000 to $65,000 depending on roof size, pitch, and material. Most homes in McKinney\'s established neighborhoods fall in the 25 to 40 square range. We provide satellite-based estimates using actual roof measurements so you have a real number before any commitment.' },
