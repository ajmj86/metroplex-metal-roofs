...
export const MCKINNEY_DATA: CityData = {
  name: 'McKinney',
  state: 'TX',
  county: 'Collin',
  region: 'North Dallas',
  ...
  neighborhoods: [
    ...
    'Tucker Hill', 'Heights at Westridge', 'Waterstone', 'Fossil Creek',
    'Adriatica', 'The Trails', 'Winding Creek', 'Prestwick Park',
  ],
  nearbyCities: [
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in McKinney, TX?', a: 'Metal roofing in McKinney typically ranges from $18,000 to $65,000 depending on roof size, pitch, and material. Most homes in McKinney\'s established neighborhoods fall in the 25 to 40 square range. We provide a satellite-based ballpark range from your roof\'s measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment. By material, that typically breaks down to about $7–$11/sq ft for R-panel, $10–$16/sq ft for stone-coated steel, $12–$18/sq ft for standing seam, and $15–$22+/sq ft for premium 24-gauge standing seam — see our full pricing table above for a size-based cost breakdown.' },
    ...
    { q: 'What is the difference between standing seam and stone-coated steel for McKinney homes?', a: 'Standing seam features clean vertical lines with hidden fasteners, well-suited to contemporary architecture. Stone-coated steel replicates the look of traditional shingles in steel form, popular in neighborhoods with traditional HOA aesthetic requirements. Both carry Class 4 hail ratings and 50-plus year lifespans.' },
  ],
}
