...
export const MANSFIELD_DATA: CityData = {
  name: 'Mansfield',
  state: 'TX',
  county: 'Tarrant',
  ...
  zip: '76063',
  slug: 'mansfield',
  metaTitle: 'Metal Roofing Mansfield TX | Metroplex Metal Roofs',
  metaDesc: 'Premium standing seam and stone-coated steel roofing in Mansfield, TX. Serving South Fort Worth area. Tarrant County neighborhoods. Satellite estimates, Class 4 hail rating.',
  ...
  neighborhoods: [
    ...
    'Saddle Ridge', 'Hurst Hills', 'Lone Star Ranch', 'Brooks Ranch',
    'Trailwood', 'Stonebrook', 'Heritage Estates', 'Crossing at Walnut Creek',
  ],
  nearbyCities: [
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Mansfield, TX?', a: 'Metal roofing in Mansfield typically ranges from $16,000 to $55,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment.' },
