...
export const TROPHY_CLUB_DATA: CityData = {
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Trophy Club, TX?', a: 'Metal roofing in Trophy Club typically ranges from $20,000 to $75,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment.' },
