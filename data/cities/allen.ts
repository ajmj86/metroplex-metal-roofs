...
export const ALLEN_DATA: CityData = {
  name: 'Allen',
  state: 'TX',
  county: 'Collin',
  region: 'North Dallas',
  zip: '75013',
  slug: 'allen',
  metaTitle: 'Metal Roofing Allen TX | Metroplex Metal Roofs',
  metaDesc: 'Premium standing seam and stone-coated steel roofing in Allen, TX. Serving Watters Crossing, Twin Creeks and surrounding Collin County neighborhoods. Satellite estimates, Class 4 hail rating.',
  ...
  neighborhoods: [
    ...
    'Ridgeview', 'Bel Air', 'The Hills of Prestonwood', 'Suncreek',
    'Bethany Mews', 'Forest Creek', 'Quail Run', 'Glendover Park',
  ],
  nearbyCities: [
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Allen, TX?', a: 'Metal roofing in Allen typically ranges from $18,000 to $65,000 depending on roof size, pitch, and material. We provide satellite-based estimates built from actual roof measurements so you have a real number before making any decisions.' },
