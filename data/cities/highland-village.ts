...
export const HIGHLAND_VILLAGE_DATA: CityData = {
  ...
  metaTitle: 'Metal & Synthetic Slate Roofing Highland Village TX | Metroplex',
  metaDesc: 'Premium standing seam, stone-coated steel, and synthetic slate roofing in Highland Village, TX. Serving Lake Lewisville area Denton County neighborhoods.',
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Highland Village, TX?', a: 'Metal roofing in Highland Village typically ranges from $18,000 to $65,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment. By material, that typically breaks down to about $7–$11/sq ft for R-panel, $10–$16/sq ft for stone-coated steel, $12–$18/sq ft for standing seam, and $15–$22+/sq ft for premium 24-gauge standing seam — see our full pricing table above for a size-based cost breakdown.' },
    ...
    { q: 'What metal roofing styles work best in Highland Village?', a: 'Standing seam and stone-coated steel are both popular in Highland Village. Standing seam suits the area\'s mix of contemporary and transitional lake-area homes. Stone-coated steel is widely chosen for traditional architecture throughout the community.' },
  ],
}
