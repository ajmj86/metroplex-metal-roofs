...
export const ROCKWALL_DATA: CityData = {
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Rockwall, TX?', a: 'Metal roofing in Rockwall typically ranges from $17,000 to $60,000 depending on roof size, pitch, and material. We provide satellite-based estimates from actual roof measurements before any commitment.' },
