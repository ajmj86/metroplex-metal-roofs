...
export const PLANO_DATA: CityData = {
  name: 'Plano',
  state: 'TX',
  county: 'Collin',
  region: 'North Dallas',
  ...
  neighborhoods: [
    ...
    'Heritage Creekside', 'Whiffletree', 'Hunters Cove', 'Ridgeview Ranch',
    'Shoal Creek', 'Lakeside on Preston', 'Pecan Hollow', 'Chapel Hill',
  ],
  nearbyCities: [
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Plano, TX?', a: 'Metal roofing in Plano typically ranges from $18,000 to $70,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — no in-person visit required to get started — refined into a firm number after your free on-site assessment. By material, that typically breaks down to about $7–$11/sq ft for R-panel, $10–$16/sq ft for stone-coated steel, $12–$18/sq ft for standing seam, and $15–$22+/sq ft for premium 24-gauge standing seam — see our full pricing table above for a size-based cost breakdown.' },
