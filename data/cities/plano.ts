...
export const PLANO_DATA: CityData = {
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Plano, TX?', a: 'Metal roofing in Plano typically ranges from $18,000 to $70,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — no in-person visit required to get started — refined into a firm number after your free on-site assessment.' },
