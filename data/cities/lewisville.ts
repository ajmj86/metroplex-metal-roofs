...
export const LEWISVILLE_DATA: CityData = {
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Lewisville, TX?', a: 'Metal roofing in Lewisville typically ranges from $16,000 to $58,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment.' },
