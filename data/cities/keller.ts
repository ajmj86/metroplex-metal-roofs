...
export const KELLER_DATA: CityData = {
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Keller, TX?', a: 'Metal roofing in Keller typically ranges from $18,000 to $65,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment.' },
