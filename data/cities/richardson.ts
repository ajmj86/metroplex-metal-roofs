...
export const RICHARDSON_DATA: CityData = {
  name: 'Richardson',
  state: 'TX',
  county: 'Dallas',
  region: 'North Dallas',
  ...
  neighborhoods: [
    ...
    'Breckinridge Park', 'Highland Terrace', 'Pebblecreek', 'Spring Creek',
    'Richland Park', 'White Rock', 'Campbell Green', 'Northrich',
  ],
  nearbyCities: [
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Richardson, TX?', a: 'Metal roofing in Richardson typically ranges from $17,000 to $60,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment. By material, that typically breaks down to about $7–$11/sq ft for R-panel, $10–$16/sq ft for stone-coated steel, $12–$18/sq ft for standing seam, and $15–$22+/sq ft for premium 24-gauge standing seam — see our full pricing table above for a size-based cost breakdown.' },
