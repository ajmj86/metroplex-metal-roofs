...
export const FORNEY_DATA: CityData = {
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Forney, TX?', a: 'Metal roofing in Forney typically ranges from $15,000 to $55,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment.' },
