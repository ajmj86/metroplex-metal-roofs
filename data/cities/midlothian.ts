...
export const MIDLOTHIAN_DATA: CityData = {
  name: 'Midlothian',
  state: 'TX',
  county: 'Ellis',
  region: 'South Dallas',
  ...
  neighborhoods: [
    ...
    'Heritage Park', 'Ashford Meadows', 'Briar Creek', 'Miller Park',
    'Westbrook', 'Canyon Creek', 'South Creek', 'Meadow Creek',
  ],
  nearbyCities: [
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Midlothian, TX?', a: 'Metal roofing in Midlothian typically ranges from $15,000 to $55,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment. By material, that typically breaks down to about $7–$11/sq ft for R-panel, $10–$16/sq ft for stone-coated steel, $12–$18/sq ft for standing seam, and $15–$22+/sq ft for premium 24-gauge standing seam — see our full pricing table above for a size-based cost breakdown.' },
    ...
    { q: 'What metal roofing styles work best in Midlothian?', a: 'Stone-coated steel and standing seam are both popular in Midlothian. Stone-coated steel in shingle profiles suits the traditional architecture common throughout the area. Standing seam is preferred for contemporary homes. Both carry Class 4 ratings and 50-plus year lifespans.' },
  ],
}
