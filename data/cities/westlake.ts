...
export const WESTLAKE_DATA: CityData = {
  ...
  zip: '76262',
  slug: 'westlake',
  metaTitle: 'Metal Roofing Westlake TX | Metroplex Metal Roofs',
  metaDesc: 'Premium standing seam and copper metal roofing in Westlake, TX. Serving Vaquero and Glenwyck Farms estates. Satellite estimates, Class 4 hail rating, HOA documentation included.',
