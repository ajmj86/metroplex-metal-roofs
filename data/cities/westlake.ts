...
export const WESTLAKE_DATA: CityData = {
  name: 'Westlake',
  state: 'TX',
  county: 'Tarrant',
  ...
  neighborhoods: [
    ...
    'Quail Hollow', 'Carlyle Court', 'Knoll Ridge', 'Stonebridge',
  ],
  nearbyCities: [
