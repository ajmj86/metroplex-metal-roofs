...
export const WESTLAKE_DATA: CityData = {
  ...
  faqs: [
    ...
    { q: 'How much does a metal roof cost in Westlake, TX?', a: 'Metal roofing in Westlake typically ranges from $25,000 to $120,000 depending on roof size, complexity, and material selection. Estate properties with copper roofing or complex standing seam systems often fall at the higher end of that range. We provide satellite-based estimates built from your roof\'s satellite-measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment.' },
