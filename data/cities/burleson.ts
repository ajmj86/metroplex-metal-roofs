...
export const BURLESON_DATA: CityData = {
  name: 'Burleson',
  state: 'TX',
  county: 'Johnson',
  ...
  zip: '76028',
  slug: 'burleson',
  metaTitle: 'Metal Roofing Burleson TX | Metroplex Metal Roofs',
  metaDesc: 'Premium standing seam and stone-coated steel roofing in Burleson, TX. Serving Johnson County communities south of Fort Worth. Satellite estimates, Class 4 hail rating.',
  ...
  neighborhoods: [
    ...
    'Shadow Creek', 'Briar Meadow', 'Lakewood', 'Homestead',
    'Park Place', 'Timber Creek', 'Elk Ridge', 'Morning Star',
  ],
  nearbyCities: [
  ...
  faqs: [
    {
      ...
      a: 'Every roof we install is covered by a 10-year workmanship warranty, written into your contract — plus the manufacturer\'s material warranty on the panels and finish. Combined with a 50+ year system lifespan, that means coverage most Burleson homeowners will never need to use.',
    },
    { q: 'How much does a metal roof cost in Burleson, TX?', a: 'Metal roofing in Burleson typically ranges from $14,000 to $50,000 depending on roof size, pitch, and material. We provide a satellite-based ballpark range from your roof\'s measured size — not a guess from the driveway — refined into a firm number after your free on-site assessment.' },
    { q: 'Does a metal roof qualify for an insurance discount in Johnson County?', a: 'Yes. Class 4 impact-rated metal roofing qualifies for significant premium discounts from most Texas carriers. Burleson homeowners in Johnson County\'s active storm corridor typically see meaningful annual premium reductions after upgrading.' },
